...
savedfile=column.to_csv(savepath+'All Features.csv', index=False)
...
mapeDF=mapeDF.rename(columns={0:'Random Forest - Stadium Percentage'})
savedfile=mapeDF.to_csv(savepath+'Stadium Percentage Random ForestMAPE.csv')
...
savedfile=df.to_csv(savepath+'modelselect3.csv',index=False)
...
forest = RandomForestRegressor(n_estimators=1000,criterion='mae',random_state=1,n_jobs=-1,max_features=37) #69
forest.fit(X_train, y_train)
y_train_pred = forest.predict(X_train)
...
df=df.rename(columns={0:'Description',1:'Stadium Percentage Random Forest'})
savedfile=df.to_csv('C:/Users/bcheasty/OneDrive - Athlone Institute Of Technology/Research Project/Data Set Creation/Data/Model/vif11.csv',index=False)

df=pd.DataFrame({'Without VIF':mapeTrain}.items())
df=df.rename(columns={0:'Description',1:'Stadium Percentage Random Forest'})
savedfile=df.to_csv('C:/Users/bcheasty/OneDrive - Athlone Institute Of Technology/Research Project/Data Set Creation/Data/Model/vif12.csv',index=False)
...
#plt.title('Stadium Percentage - RF - Residuals')
plt.legend()
plt.show()
...
plt.legend(loc='upper left')
#plt.title('Stadium Percentage - RF - Normal Q-Q')
...
savedfile=pvalue.to_csv('C:/Users/bcheasty/OneDrive - Athlone Institute Of Technology/Research Project/Data Set Creation/Data/Model/pvalue6.csv',index=False)
...
#plot_lm_3.axes[0].set_title('Stadium Percentage - RF - Scale-Location')
...
savedfile=bp.to_csv('C:/Users/bcheasty/OneDrive - Athlone Institute Of Technology/Research Project/Data Set Creation/Data/Model/bp6.csv',index=False)
...
df3=df.join(df2)
mrresults2=['Stadium Percentage Random Forest',rmse_train,rmse_test,r2_train,r2_test,mapeTrain,mapeTest]
...
savedfile=regResult3.to_csv(savepath+'Stadium Percentage Random Forest Test.csv',index=False)
