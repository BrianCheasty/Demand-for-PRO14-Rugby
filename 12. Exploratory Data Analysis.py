...
attenddata2=attenddata[['Round','Home Table Position','Away Table Position','Home Last_5_W/L','LastGame','Away Last_5_W/L','Max Temperature','Rain Level',\
                                                    ...
                                                    'Game Competitiveness_Has Qualified','Away Country_Ireland','Away Country_Italy','Away Country_Scotland',\
                                                        'Away Country_Wales','Temperature_Cold','Temperature_Warm','Wind_Calm','Wind_Normal','Rain_Damp',\
                                                            'Rain_Wet','Age of Stadium_Middle Age','Age of Stadium_Old','Win Probability Dummy_Even',\
                                                                'Win Prob Squared','Away Team_ASM Clermont Auvergne','Away Team_Agen','Away Team_Bath Rugby',\
                                                                    'Away Team_Benetton Treviso','Away Team_Bordeaux-Begles','Away Team_Bristol Rugby',\
                                                                        'Away Team_Brive','Away Team_Cardiff Blues','Away Team_Castres Olympique',\
                                                                            'Away Team_Connacht Rugby','Away Team_Dragons','Away Team_Edinburgh Rugby',\
                                                                                'Away Team_Enisei-STM','Away Team_Exeter Chiefs','Away Team_Glasgow Warriors','Away Team_Gloucester Rugby','Away Team_Grenoble',\
                                                                                    'Away Team_Harlequins','Away Team_La Rochelle','Away Team_Leicester Tigers','Away Team_Leinster Rugby',\
                                                                                        'Away Team_London Irish','Away Team_Lyon','Away Team_Montpellier','Away Team_Munster Rugby','Away Team_Newcastle Falcons',\
                                                                                            'Away Team_Northampton Saints','Away Team_Ospreys','Away Team_Oyonnax','Away Team_Pau','Away Team_Perpignan','Away Team_RC Toulon',\
                                                                                                'Away Team_Racing 92','Away Team_Rugby Calvisano','Away Team_Sale Sharks','Away Team_Saracens','Away Team_Scarlets','Away Team_Stade Francais Paris',\
                                                                                                    'Away Team_Timisoara Saracens','Away Team_Toulouse','Away Team_Ulster Rugby','Away Team_Wasps','Away Team_Worcester Warriors',\
                                                                                                        'Away Team_Zebre Rugby',\
                                                                                                            'Attendance']]
...
attendsp=attendsp[['Round','Home Table Position','Away Table Position','Home Last_5_W/L','LastGame','Away Last_5_W/L','Max Temperature','Rain Level',\
                        'Wind Speed','Last Game in Comp','Home Win/Loss in Comp','Home Total P','Day Of Week','Month of Year','Home Winning Percentage',\
                            'homeVSaway Winning Percentage','Number ofP14 Wins','Years sinceEPCR Win','Stadium Age','Stadium Capacity','Table Difference',\
                                'Sentiment','Win Probability','Tournament_Champions Cup','Tournament_League','Home Team_Benetton Treviso',\
                                    'Home Team_Cardiff Blues','Home Team_Connacht Rugby','Home Team_Edinburgh Rugby','Home Team_Dragons','Home Team_Ospreys',\
