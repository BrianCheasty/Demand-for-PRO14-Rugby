...
# plot_lm_4.axes[0].set_title('Stadium Percentage - Reg - Residuals vs Leverage')
...
plt.title('Stadium Percentage - Reg - Features vs MAPE vs Overfit')
plt.legend(loc='upper right')
plt.hlines(y=0.1882, xmin=0, xmax=106, color='red', lw=.5)
plt.xlim([0, 106])
