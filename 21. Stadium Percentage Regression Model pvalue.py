...
with open('C:/Users/bcheasty/OneDrive - Athlone Institute Of Technology/Research Project/Data Set Creation/Data/Model/OLS Summary SP.html', 'w') as fh:
    fh.write(model_fit.summary().as_html())
with open('C:/Users/bcheasty/OneDrive - Athlone Institute Of Technology/Research Project/Data Set Creation/Data/Model/OLS Summary SP.csv', 'w') as fh:
    fh.write(model_fit.summary().as_csv())

featurepvalue=['Home_Lst_3_Win','Sentiment_Under 110','Sentiment_Under 115','Tournament_Champions Cup','Home_Team_Dragons','Home_Team_Ospreys',\
               'Home_Team_Scarlets','Home_Team_Zebre Rugby','Venue_BT Murrayfield','Venue_Irish Independent Park','Venue_Myreside',\
                   'Venue_Thomond Park','Yrs_P14_Win_Within Three','Yrs_EPCR_Win_Four to Six','Yrs_EPCR_Win_Within Three','Derby_Non Derby',\
                       'Month_of_Year_Second Q','Kick_off_Hour_Early','Stadium_Age_Dummy_New','Stadium_Age_Dummy_Old']   
...
savedfile=fpvalue.to_csv(savepath+'Regression Stadium Percentage pvalue.csv',index=False)
...
X_train2=X_train2.drop(columns=['Home_Team_Dragons'])
X_test2=X_test2.drop(columns=['Home_Team_Dragons'])
...
#plt.title('Stadium Percentage - Reg(p-value) - Residuals vs Fitted')
...
#plt.title('Stadium Percentage - Reg(p-value) - Residuals')
plt.legend()
plt.show()
...
df3=df.join(df2)
mrresults2=['Stadium Percentage Regression pvalue',rmse_train,rmse_test,r2_train,r2_test,mapeTrain,mapeTest]
...
savedfile=regResult3.to_csv(savepath+'Stadium Percentage Regression Test pvalue.csv',index=False)