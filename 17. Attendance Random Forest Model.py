...
savedfile=regResult1.to_csv('C:/Users/bcheasty/OneDrive - Athlone Institute Of Technology/Research Project/Data Set Creation/Data/Model/Attendance Random Forest Model/Attendance Random Forest.csv',index=False)
"""########################
Plot the Model
"""
...
plt.title('Attendance - RF - Features vs MAPE vs Overfit')
plt.legend(loc='upper right')
plt.hlines(y=0.209489, xmin=0, xmax=106, color='red', lw=.5)
plt.xlim([0, 106])
...
forest = RandomForestRegressor(n_estimators=500,criterion='mse',random_state=1,n_jobs=-1, max_features=71)
...
savedfile=regResult1.to_csv(savepath+'Test Attendance Random Forest.csv',index=False)
